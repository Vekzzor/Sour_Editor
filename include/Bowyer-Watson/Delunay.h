...
{
public:
	static void Triangulate(std::vector<HALF_EDGE::HE_Vertex*>& points,
...
private:
	...
	static bool findIntersections(HALF_EDGE::HE_Vertex* pt,
								  std::vector<HALF_EDGE::HE_Face*> faces,
								  std::map<HALF_EDGE::HE_Face*, bool>& intersections,
								  std::vector<HALF_EDGE::HE_Edge*>& edges);
	static void neighborIntersections(HALF_EDGE::HE_Vertex* pt,
